#https://athenajc.gitbooks.io/python-gtk-3-api/content/gtk-group/gtkfilechooserdialog.html
#https://docs.gtk.org/gtk3/class.InfoBar.html

#TODO
#Read Qr-Code from screenshot
#Add paypal and bitcoin to generator
