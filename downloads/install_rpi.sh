...
function install() {
  if (( $EUID != 0 )); then
      ...
      wget https://github.com/coder12341/qr-tools/releases/download/2.0/qr-generator-cli_rpi -O qr-generator 
  ...
  echo "Installing..."
  {
  cd /bin && wget https://github.com/coder12341/qr-tools/releases/download/2.0/qr-generator-cli_rpi -O qr-generator
  chmod +x qr-generator
